...
* 'pw_parser' subfolder contains code necessery to extract imformation from programmableweb repository and store it in RDF graph.
* 'analysis' subfolder contains ipython notebook script, which describe some main characteristics of experiment_graph.ttl as well as some characteristics related to functionality diffusion between Web APIs.
