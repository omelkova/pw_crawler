...
def single_experiment(mashup, g, range_tuple):
...
def experiment():
    ...
    for mashup in mashup_for_experiment:
        print(mashup)
        arr_of_precisions = [mashup] + single_experiment(mashup, g, range_tuple)
    ...
    average_precision_frame.to_csv("1_0_1_result.csv")
